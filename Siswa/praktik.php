    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
          	<a class="nav-link" href="praktik.php"><img class="menu-icon" src="../vendor/images/menu_icons/4.png" alt="menu icon"><span class="menu-title">Praktik</span></a>
          </li>
      ...
      <div class="main-panel">
           ...
           <!-- Konten -->
                ...
                <h3> <b>Praktikum</b> <small class="text-muted">/Siswa</small>
                </h3>
                <hr>
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <h1> Compiler </h1>
                      <div data-pym-src="https://www.jdoodle.com/plugin" data-language="php"
